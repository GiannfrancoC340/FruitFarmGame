  ...
  return (
    <div className="App">
      <div className="header">
        ...
        <img className="orange" src="https://png.pngtree.com/element_our/png/20180903/orange-png-png_75700.jpg" alt="orange"/>
      ...
      <div className="container">
        <div className="upgrade">
          ...
          <p>2x per click</p>
          <button onClick={buyDoubleStuffed}>10 apples</button>
        </div>
        <div className="upgrade">
          <h3>Party Pack 🎉</h3>
          <p>5x per click</p>
          <button onClick={buyPartyPack}>100 apples</button>
        </div>
        <div className="upgrade">
          <h3>Full Feast 👩🏽‍🍳</h3>
          <p>10x per click</p>
          <button onClick={buyFullFeast}>1000 apples</button>
        </div>
      </div>
    </div>
  )
